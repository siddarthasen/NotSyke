...
questions = [
    ...
    {id: 81, first: "", second: " just had a dream, what was it about?"},
    {id: 82, first: "What's a family heirloom that ", second: " might treasure?"},
    {id: 83, first: "", second: " just got rich off of investments, what did they invest in?"},
    {id: 84, first: "What's a pick up line that ", second: " might use?"},
    {id: 85, first: "", second: " seems happy today, what might have happened?"},
    {id: 86, first: "", second: " seems sad today, what might have happened?"},
    {id: 87, first: "", second: " just made a new ice cream flavor, what's it called?"},
    {id: 88, first: "", second: " just made a birthday wish, what was it?"},
    {id: 89, first: "", second: " just voiced a cartoon character, who might they have been"},
    {id: 90, first: "What's ", second: "'s deepest regret"},
	{id: 91, first: "", second: " just had a strange dream, what happened in it?"},
	{id: 92, first: "", second: " just created an imaginary language, what's it called?"},
	{id: 93, first: "If ", second: " was a transformer, what car could they turn into?"},
	{id: 94, first: "The zombie apocalypse has arrived, where does ", second: " go first?"},
	{id: 95, first: "", second: " just joined the circus, what's their circus act?"},
	{id: 96, first: "", second: " just won a gold medal at the olympics, what even did they participate in?"},
	{id: 97, first: "", second: " just started a sports team, what's their team mascot?"},
	{id: 98, first: "", second: " just started a brand, what's it's tag line?"},
	{id: 99, first: "If ", second: " was a superhero, what would their name be?"},
	{id: 100, first: "What's the first link that pops up when you google ", second: "'s name?"},
